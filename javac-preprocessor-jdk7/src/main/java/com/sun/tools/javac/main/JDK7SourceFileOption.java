...
public class JDK7SourceFileOption extends JavacOption.HiddenOption {

    private Main main;
    private Set<String> extensions;

    public JDK7SourceFileOption(Main main, Set<String> additionalExtensions) {
